                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="cat_name" class="form-control" placeholder="Enter Name" required />
                            </div>
                            <div class="col">
                                <label class="form-label">Code</label>
                                <input type="text" name="cat_code" class="form-control" placeholder="AL001" required />
                            </div>
                            <div class="col form-group">
                                <label class="form-label">Status </label>
                                <select class="form-control select2-show-search form-select" name="cat_status" data-placeholder="Choose one" required>
