<?php 
include_once ('donation/donations/query.php');
echo '  
<!-- TITLE -->
<title>Manage Donations - '.TITLE_HEADER.'</title>
    <div class="app-content main-content mt-0">
        <div class="side-app">
            <div class="main-container container-fluid">
                <div class="page-header">
	                <div><h1 class="page-title">Donations</h1></div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12">';
                        if(isset($_GET['add'])){
                            include_once ('donation/donations/add.php');
                        }elseif(isset($_GET['id'])){
                            include_once ('donation/donations/edit.php');
                        }else{
