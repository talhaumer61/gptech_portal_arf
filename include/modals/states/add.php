<?php
    ...
    $state  = $dblms->getRows(STATES, $conOrdering);
    if($state){
        $ordering = $state['state_id'] + 1;
    }else{
        $ordering = 1;
    }
    $condition = array ( 
        ...
        <div class="modal-dialog modal-dialog-centered text-center modal-lg" role="document">
            <div class="modal-content modal-content-demo expanel expanel-primary">
                <div class="modal-header expanel-heading">
                    <h6 class="modal-title">Add State</h6><button aria-label="Close" class="btn-close text-white" data-bs-dismiss="modal" ><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="states.php" autocomplete="off" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input class="form-control" name="state_ordering" value="'.$ordering.'" readonly type="number" required>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="expanel-footer modal-footer">
                        <button type="submit" class="btn btn-primary" name="submit_add" >Add States</button> 
