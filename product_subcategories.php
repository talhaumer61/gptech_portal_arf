...
echo '  
<!-- TITLE -->
<title>Manage Product Sub Categories - '.TITLE_HEADER.'</title>
<!-- BOOTSTRAP CSS -->
...
<div class="page-header">
	<div><h1 class="page-title">Product Sub Categories</h1></div>
...
<div class="col-lg-12">';
//------------------------------------------
	include_once ('include/settings/product_subcategories/query.php');
    include_once ('include/settings/product_subcategories/list.php');
	include_once("include/settings/product_subcategories/modal-add.php");
//-----------------------------------------
echo '
</div>
</div>
...
echo '
	...
	include_once("include/settings/product_subcategories/modal-edit.php");
	include_once("include/settings/product_subcategories/modal-delete.php");
	echo'
</body>
</html>';
?>