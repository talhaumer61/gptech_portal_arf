<?php 
include_once ('donors/query.php');
echo '  
<!-- TITLE -->
<title>Manage Donors - '.TITLE_HEADER.'</title>
    <div class="app-content main-content mt-0">
        <div class="side-app">
            <div class="main-container container-fluid">
                <div class="page-header">
	                <div><h1 class="page-title">Donors</h1></div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12">';
                        if(isset($_GET['add'])){
                            include_once ('donors/add.php');
                        }elseif(isset($_GET['id'])){
                            include_once ('donors/edit.php');
                        }else{
                            include_once ('donors/list.php');
                        }
                        echo '
                    </div>
                </div>                     
