<?php 
include_once ('settings/area_settings/states/query.php');
echo '  
<!-- TITLE -->
<title>Manage States - '.TITLE_HEADER.'</title>
    <div class="app-content main-content mt-0">
        <div class="side-app">
            <div class="main-container container-fluid">
                <div class="page-header">
	                <div><h1 class="page-title">States</h1></div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12">';
                        include_once ('settings/area_settings/states/list.php');
                        echo '
                    </div>
                </div>                     
            </div>
