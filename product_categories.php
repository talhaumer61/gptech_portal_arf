...
echo '  
<!-- TITLE -->
<title>Manage Product Categories - '.TITLE_HEADER.'</title>
<!-- BOOTSTRAP CSS -->
...
<div class="page-header">
	<div><h1 class="page-title">Product Categories</h1></div>
...
<div class="col-lg-12">';
//------------------------------------------
	include_once ('include/settings/product_categories/query.php');
    include_once ('include/settings/product_categories/list.php');
	include_once("include/settings/product_categories/modal-add.php");
//-----------------------------------------
echo '
</div>
</div>
...
echo '
	...
	include_once("include/settings/product_categories/modal-edit.php");
	include_once("include/settings/product_categories/modal-delete.php");
	echo'
</body>
</html>';
?>