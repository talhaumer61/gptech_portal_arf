...
document.querySelector("#cleave-phone") && (cleaveBlocks = new Cleave("#cleave-phone", { delimiters: ["-"], blocks: [4, 7] }));
document.querySelector("#cleave-whatsapp") && (cleaveBlocks = new Cleave("#cleave-whatsapp", { delimiters: ["-"], blocks: [4, 7] }));
document.querySelector("#cleave-cnic") && (cleaveBlocks = new Cleave("#cleave-cnic", { delimiters: ["-","-"], blocks: [5, 7, 1] }));