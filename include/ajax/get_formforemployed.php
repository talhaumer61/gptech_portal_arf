    ...
    if(isset($_POST['ap_job_status']) && $_POST['ap_job_status'] == 1){
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="ap_profession" class="form-control" placeholder="Profession Name" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="form-label">Name of Organization <span class="text-danger">*</span></label>
                    <input type="text" name="ap_organization" class="form-control" placeholder="Organization Name" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="date" name="ap_doj" class="form-control" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="form-label">Office Phone <span class="text-danger">*</span></label>
                    <input type="text" name="ap_office_phone" class="form-control" placeholder="Office Phone" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="form-label">Office Email <span class="text-danger">*</span></label>
                    <input type="email" name="ap_office_email" class="form-control" placeholder="example@domain.com" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <textarea name="ap_office_address" class="form-control" placeholder="Office Address"></textarea>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="ap_monthly_income" class="form-control" placeholder="Enter Amount" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="form-label">Previous Loan Amount <span class="text-danger">*</span></label>
                    <input type="text" name="ap_previous_loan" class="form-control" placeholder="Enter Amount" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="form-label">Deduction of Loan (if any) <span class="text-danger">*</span></label>
                    <input type="text" name="ap_previous_loan_deduction" class="form-control" placeholder="Enter Amount" required>
                </div>
            </div>
        </div>
        ';
