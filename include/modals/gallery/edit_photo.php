<?php 
    ...
    $fileInfo = pathinfo($_GET['gal_photo']);
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content modal-content-demo expanel expanel-primary">
            ...
            <form autocomplete="off" class="form-validate"  enctype="multipart/form-data" method="post" accept-charset="utf-8">
                <input type="hidden" class="form-control" name="edit_id" value="'.$_GET['edit_id'].'"required/>
                ...
                <input type="hidden" class="form-control" name="filename" value="'.$fileName.'"required/>
                <div class="modal-body expanel-body">
                    <div class="row">
                        <div class="col form-group">
                            <label class="form-label">Photo Name</label>
                            <input type="text" class="form-control" value="'.$_GET['gal_photo'].'" readonly/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col form-group">
                    ...
                    <div class="row">
                        <div class="col form-group">
                            ...
                            <input type="file" name="gal_photo" accept=".jpg, .jpeg, .png" class="dropify" data-bs-height="100"/>
                        </div>
                    </div>
                </div>
