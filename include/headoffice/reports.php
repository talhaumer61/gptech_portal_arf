<?php 
include_once ('settings/site_settings/reports/query.php');
echo '  
<!-- TITLE -->
<title>Manage Reports / Downloads - '.TITLE_HEADER.'</title>
    <div class="app-content main-content mt-0">
        <div class="side-app">
            <div class="main-container container-fluid">
                <div class="page-header">
	                <div><h1 class="page-title">Reports / Downloads</h1></div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Site Setting</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Reports - Downloads</li>
                        </ol>
                    </div>
                </div>
                <div class="row row-sm">
                    <div class="col-lg-12">';
                        include_once ('settings/site_settings/reports/list.php');
                        echo '
                    </div>
                </div>                     
            </div>
