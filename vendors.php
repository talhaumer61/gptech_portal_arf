...
echo '  
<!-- TITLE -->
<title>Manage Vendors - '.TITLE_HEADER.'</title>
<!-- BOOTSTRAP CSS -->
...
<div class="page-header">
	<div><h1 class="page-title">Vendors</h1></div>
...
<div class="col-lg-12">';
//------------------------------------------
	include_once ('include/settings/vendors/query.php');
    include_once ('include/settings/vendors/list.php');
	include_once("include/settings/vendors/modal-add.php");
//-----------------------------------------
echo '
</div>
</div>
...
echo '
	...
	include_once("include/settings/vendors/modal-edit.php");
	include_once("include/settings/vendors/modal-delete.php");
	echo'
</body>
</html>';
?>