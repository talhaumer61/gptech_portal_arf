...
echo '  
<!-- TITLE -->
<title>Manage Brands - '.TITLE_HEADER.'</title>
<!-- BOOTSTRAP CSS -->
...
<div class="page-header">
	<div><h1 class="page-title">Brands</h1></div>
...
<div class="col-lg-12">';
//------------------------------------------
	include_once ('include/settings/brands/query.php');
    include_once ('include/settings/brands/list.php');
	include_once("include/settings/brands/modal-add.php");
//-----------------------------------------
echo '
</div>
</div>
...
echo '
	...
	include_once("include/settings/brands/modal-edit.php");
	include_once("include/settings/brands/modal-delete.php");
	echo'
</body>
</html>';
?>