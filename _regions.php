...
echo '  
<!-- TITLE -->
<title>Manage Regions - '.TITLE_HEADER.'</title>
...
<div class="page-header">
	<div><h1 class="page-title">Regions</h1></div>
...
<div class="col-lg-12">';
//------------------------------------------
	include_once ('include/settings/regions/query.php');
    include_once ('include/settings/regions/list.php');
	include_once("include/settings/regions/modal-add.php");
//-----------------------------------------
echo '
</div>
</div>
...
echo '
	...
	include_once("include/settings/regions/modal-edit.php");
	include_once("include/settings/regions/modal-delete.php");
	echo'
</body>
</html>';
?>