...
echo '  
<!-- TITLE -->
<title>Manage Vendor Business - '.TITLE_HEADER.'</title>
<!-- BOOTSTRAP CSS -->
...
<div class="page-header">
	<div><h1 class="page-title">Business</h1></div>
...
<div class="col-lg-12">';
//------------------------------------------
	include_once ('include/settings/businesses/query.php');
    include_once ('include/settings/businesses/list.php');
	include_once("include/settings/businesses/modal-addLinkAccount.php");
	include_once("include/settings/businesses/modal-add.php");
//-----------------------------------------
echo '
</div>
</div>
...
echo '
	...
	include_once("include/settings/businesses/modal-viewLinkAccount.php");
	include_once("include/settings/businesses/modal-edit.php");
	include_once("include/settings/businesses/modal-delete.php");
	echo'
</body>
</html>';
?>