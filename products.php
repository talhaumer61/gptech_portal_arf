...
echo '  
<!-- TITLE -->
<title>Manage Products - '.TITLE_HEADER.'</title>
<!-- BOOTSTRAP CSS -->
...
<div class="col-lg-12">';
//------------------------------------------
	include_once ('include/settings/products/query.php');
    include_once ('include/settings/products/list.php');
	include_once("include/settings/products/modal-add.php");
//-----------------------------------------
echo '
</div>
</div>
...
echo '
	...
	include_once("include/settings/products/modal-edit.php");
	include_once("include/settings/products/modal-delete.php");
	echo'
</body>
</html>';
?>