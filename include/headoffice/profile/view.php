...
if(!empty($row['adm_photo'])){
    ...
    $photo = ''.SITE_URL.'/uploads/images/admin/default.jpg';
}
echo '
                ...
                <div class="row">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                        <img src="'.$photo.'" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                                    </div>
                    ...
                    <div class="col-xxl-9 col-xl-8 col-lg-8">
                        <div class="card mt-xxl-n5">
                            <div class="card-header bar_Line">
                                <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                    <li class="nav-item">
                                        <a class="pt-5 pl-5 pr-5 mar nav-link text-body active" id="active" data-bs-toggle="tab" href="#personalDetails" role="tab">
                                            <b>Personal Details</b>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="pt-5 pl-5 pr-5 mar nav-link text-body" data-bs-toggle="tab" href="#changePassword" role="tab">
                                            <b>Change Password</b>
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                        <form action="profile.php" enctype="multipart/form-data" autocomplete="off" method="post" accept-charset="utf-8">  
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label for="adm_fullnameInput" class="form-label">Full Name <span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="cleave-phone" class="form-label">Phone <span class="text-danger">*</span></label>
                                                        <input type="text" name="adm_phone" class="form-control" required id="cleave-phone" placeholder="xxxx-xxxxxxx"  value="'.$row['adm_phone'].'">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="adm_emailInput" class="form-label">Email <span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="adm_photo" accept="image/*" class="dropify" data-bs-height="100"/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
