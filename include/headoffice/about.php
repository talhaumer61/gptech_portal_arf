<?php 
include_once ('settings/site_settings/about/query.php');
echo '  
<!-- TITLE -->
<title>Manage About - '.TITLE_HEADER.'</title>
    <div class="app-content main-content mt-0">
        <div class="side-app">
            <div class="main-container container-fluid">
                <div class="page-header">
	                <div><h1 class="page-title">About</h1></div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12">';
                        if(isset($_GET['id'])){
                            include_once ('settings/site_settings/about/edit.php');
                        }else{
                            include_once ('settings/site_settings/about/list.php');
                        }
