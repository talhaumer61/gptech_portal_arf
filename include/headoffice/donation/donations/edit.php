<?php
    // DONATION
    $condition = array ( 
                        'select'        =>  'id, id_donor, status, id_type, id_pc_subcat, dated, fullname, cnic, phone, email, referrals, amount',
                        'where'         =>  array( 
                                                    'id'        => $_GET['id']
                                                ), 
                        'return_type'   =>  'single'
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2-show-search form-select" name="id_donor" data-placeholder="Select" required>
                                        ...
                                        foreach ($DONORS as $donor):
                                            echo'<option value="'.$donor['dv_id'].'" '.($donor['dv_id'] == $row['id_donor'] ? 'selected' : '').'>'.$donor['dv_full_name'].' ( '.$donor['dv_donor_id'].' )</option>';
                                        endforeach;
                                        echo'
                                    </select>
                                </div>
