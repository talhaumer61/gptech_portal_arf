            ...
            <body>
                ...
                <table width="960" align="center" style="text-align: left; margin-top: 18px;">
                    <thead>
                        <tr>
                            <th width="40">NAME:</th>
                            <th class="b-b">'.($donation['is_by_portal'] == 1 ? $donation['dv_full_name'] : $donation['fullname']).'</th>
                        </tr>
                    </thead>
                </table>
                <table width="960" align="center" style="text-align: left; margin-top: 18px;">
                    <thead>
                        <tr>
                            ...
                            <th class="b-b" width="250">'.($donation['is_by_portal'] == 1 ? $donation['dv_cnic'] : $donation['cnic']).'</th>
                            <th width="80">Phone NO:</th>
                            <th class="b-b" width="230">'.($donation['is_by_portal'] == 1 ? $donation['dv_phone'] : $donation['phone']).'</th>
                            <th width="55">E-mail:</th>
                            <th class="b-b">'.($donation['is_by_portal'] == 1 ? $donation['dv_email'] : $donation['email']).'</th>
                        </tr>
                    </thead>
                </table>
                <table width="960" align="center" style="text-align: left; margin-top: 18px;">
