<?php 
include_once ('settings/site_settings/slider/query.php');
echo '  
<!-- TITLE -->
<title>Manage Slider - '.TITLE_HEADER.'</title>
    <div class="app-content main-content mt-0">
        <div class="side-app">
            <div class="main-container container-fluid">
                <div class="page-header">
	                <div><h1 class="page-title">Slider</h1></div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12">';
                        include_once ('settings/site_settings/slider/list.php');
                        echo '
                    </div>
                </div>                     
            </div>
