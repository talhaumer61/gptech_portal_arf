...
echo '  
<!-- TITLE -->
<title>Manage Banks - '.TITLE_HEADER.'</title>
<!-- BOOTSTRAP CSS -->
...
<div class="page-header">
	<div><h1 class="page-title">Banks</h1></div>
...
<div class="col-lg-12">';
//------------------------------------------
	include_once ('include/settings/banks/query.php');
    include_once ('include/settings/banks/list.php');
	include_once("include/settings/banks/modal-add.php");
//-----------------------------------------
echo '
</div>
</div>
...
echo '
	...
	include_once("include/settings/banks/modal-edit.php");
	include_once("include/settings/banks/modal-delete.php");
	echo'
</body>
</html>';
?>